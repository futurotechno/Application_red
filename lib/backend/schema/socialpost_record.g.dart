...
part of 'socialpost_record.dart';

// **************************************************************************
// BuiltValueGenerator
// **************************************************************************

Serializer<SocialpostRecord> _$socialpostRecordSerializer =
    new _$SocialpostRecordSerializer();

class _$SocialpostRecordSerializer
    implements StructuredSerializer<SocialpostRecord> {
  @override
  final Iterable<Type> types = const [SocialpostRecord, _$SocialpostRecord];
  @override
  final String wireName = 'SocialpostRecord';

  @override
  Iterable<Object?> serialize(Serializers serializers, SocialpostRecord object,
  ...
  @override
  SocialpostRecord deserialize(
      Serializers serializers, Iterable<Object?> serialized,
      {FullType specifiedType = FullType.unspecified}) {
    final result = new SocialpostRecordBuilder();
...
class _$SocialpostRecord extends SocialpostRecord {
  @override
  ...
  factory _$SocialpostRecord(
          [void Function(SocialpostRecordBuilder)? updates]) =>
      (new SocialpostRecordBuilder()..update(updates))._build();

  _$SocialpostRecord._(
      {this.postPhoto,
      this.postTitle,
  ...
  @override
  SocialpostRecord rebuild(void Function(SocialpostRecordBuilder) updates) =>
      (toBuilder()..update(updates)).build();

  @override
  SocialpostRecordBuilder toBuilder() =>
      new SocialpostRecordBuilder()..replace(this);

  @override
  bool operator ==(Object other) {
    if (identical(other, this)) return true;
    return other is SocialpostRecord &&
  ...
  @override
  String toString() {
    return (newBuiltValueToStringHelper(r'SocialpostRecord')
...
class SocialpostRecordBuilder
    implements Builder<SocialpostRecord, SocialpostRecordBuilder> {
  _$SocialpostRecord? _$v;
  ...
  SocialpostRecordBuilder() {
    SocialpostRecord._initializeBuilder(this);
  }

  SocialpostRecordBuilder get _$this {
    final $v = _$v;
    if ($v != null) {
  ...
  @override
  void replace(SocialpostRecord other) {
    ArgumentError.checkNotNull(other, 'other');
    _$v = other as _$SocialpostRecord;
  }

  @override
  void update(void Function(SocialpostRecordBuilder)? updates) {
    if (updates != null) updates(this);
  }

  @override
  SocialpostRecord build() => _build();

  _$SocialpostRecord _build() {
    _$SocialpostRecord _$result;
    try {
      _$result = _$v ??
          new _$SocialpostRecord._(
              postPhoto: postPhoto,
              postTitle: postTitle,
      ...
      try {
        ...
        throw new BuiltValueNestedFieldError(
            r'SocialpostRecord', _$failedField, e.toString());
      }
      rethrow;
    }
    replace(_$result);
